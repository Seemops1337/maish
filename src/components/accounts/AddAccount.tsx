...
import { AddCardDavAccount } from "./AddCardDavAccount";
...
type View = "select-provider" | "gmail" | "imap" | "caldav" | "carddav";
      ...
      <Modal isOpen={true} onClose={onClose} title="Add Gmail Account" width="w-full max-w-md">
        <div className="p-4">
          <p className="text-text-secondary text-sm mb-6">
            Sign in with your Google account to connect it to Maish.
          </p>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-text-tertiary mt-0.5">
                Connect iCloud, Fastmail, Nextcloud, or any CardDAV address book
              </div>
            </div>
          </button>
        </div>
