  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        summary: "Sync contacts from iCloud, Nextcloud, or any DAV server.",
        description:
          "Connect a CardDAV server to sync its address books into Maish. Synced contacts appear on the Contacts page and in the composer's autocomplete alongside the ones collected from your mail, and a contact you already emailed is merged into its synced card rather than listed twice. Editing or deleting a contact writes the change straight to the server; an address book shared with you read-only is shown but cannot be changed.",
        tips: [
          { text: "Add one under Settings > Accounts, or as its own account for contacts only." },
          { text: "The server URL is usually found for you from your email address." },
          { text: "iCloud and Fastmail need an app-specific password, not your normal one." },
          { text: "Switch individual address books off to leave them out of the sync." },
          { text: "Open the Contacts page from the sidebar." },
        ],
        relatedSettingsTab: "accounts",
      },
    ],
