...
Maish follows a **three-layer architecture** with clear separation of concerns.
...
SQLite via Tauri SQL plugin. 24 migrations, 36 tables total.
...
Maish supports standard Linux distribution formats via automated and local build processes:
